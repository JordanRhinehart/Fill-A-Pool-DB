      ...
      <!-- <section class="section customer-homepage.transheader parallax" data-stellar-background-ratio="0.3">
        <div class="container">
          <div class="row">
            ...
            <h2 style="background-image: url('splash.jpg');"></h2>
...
<!-------------------------------------------------------------------------------------------------->
        ...
        <form class="formy" action="AppointmentsPageQuery.php" method="POST">
              ...
              <div class="table-form c1">
                    <table border="1" cellspacing="5" cellpadding="5" width="100%">
                        ...
                        <?php
                            require_once('connection.php');
                            $result = mysqli_query($conn,"SELECT * FROM upcoming_jobs WHERE first_name = 'null'
                           AND last_name = 'null' ORDER BY job_id ASC");
                            for($i=0; $row = mysqli_fetch_array($result); $i++){
                        ?>
                            <tr>
                                <td><label><?php echo $row['job_id'] ; ?></label></td>
...
<!-------------------------------------------------------------------------------------------------->
            ...
            <form id="Class2" class="formy" action="insert2.php" method="POST">
...
<!-------------------------------------------------------------------------------------------------->
          ...
          <form id="Class3" class="formy" action="remove2.php" method="POST">
