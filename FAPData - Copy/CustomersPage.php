...
<!-------------------------------------------------------------------------------------------------->
          ...
          <form class="formy" action="CustomersPageQuery.php" method="POST">
              ...
              <div>
              <div class="table-form c1" id="Class1">
                    <table border="1" cellspacing="5" cellpadding="5" width="100%">
                        <thead>
                            <tr>
                                <th>id</th>
                        ...
                        <?php
                            ...
                            first_name = 'null' AND last_name = 'null' ORDER BY id ASC LIMIT 10");
